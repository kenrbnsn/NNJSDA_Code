...
<html>
	...
	<meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
		<link type="text/css" rel="stylesheet" href="http://yui.yahooapis.com/2.3.0/build/container/assets/container.css">				
		...
		<link type="text/css" rel="stylesheet" href="http://yui.yahooapis.com/2.3.0/build/logger/assets/logger.css">
		<style>
...
//				event_panel.setBody(tmp[2]);
				...
				event_panel.cfg.queueProperty("postmethod", "async");
...
//					oButton5.addListener("click", updateEvent);
//					oButton6.addListener("click", deleteEvent);
//					oButton7.addListener("click", handleCancel);
	...
	<body class="yui-skin-sam">
		<div class="x">&nbsp;
			<div id="container0">
				...
				<div class="ft">
				<div id="commentbutton" class="yui-button yui-push-button" style="float:right">
                                	<span class="first-child">
						<button type="button" name="commnetbutton" style="font-size:75%"></button>
					</span>
					<div class="clearer">&nbsp;</div>
				</div>                 
				<div id="yearbutton1"  class="yui-button yui-push-button" style="float:right">
                                	<span class="first-child">
						<button type="button" name="yearbutton1" style="font-size:75%"></button>
					</span>
					<div class="clearer">&nbsp;</div>
				</div>
				<div class="clearer">&nbsp;</div>
		...
		<div id="dialog1">
			...
			<div class="bd">
				<form method="POST" action="<?php echo $_SERVER['PHP_SELF']?>">
					<label for="name">Name:</label><input type="textbox" name="name" id="comment_name" /><br>
					<label for="email">E-mail:</label><input type="textbox" name="email" id="comment_email" /><br> 
					<label for="comment">Comment:</label><textarea style="width: 80%" name="comment" id="comment_comment" rows="10"></textarea>
					<div class="clear"></div>
				</form>
			<div class="ft"></div>
			</div>
		...
		<div id="event_panel" style="display:block;width:700px;">
			<div class="hd" id="event_header" style="text-align:center">
			</div>
			<div class="bd">
				 ...
				 <span class="formw"><select class="txtinp" id="event_org" name="event_org" size="1">
				...
				?>
				 ...
				 <span class="formw"><select class="txtinp" id="event_type" name="event_type" size=1>
				 	<option value=""></option>
				 <?php
				...
				?>
				 ...
				 <span class="formw"><input name="event_name" id="event_name" type="text" class="txtinp"></span>
				 </div>
				 <div class="row">
				 <span class="label2">Event Description:</span>
				 <span class="formw"><textarea class="txtinp" rows="5" id="event_description" name="event_description"></textarea></span>
				 </div>
				 <div class="row">
				 <span class="label2">Event URL:</span>
				 <span class="formw"><input name="event_url" id="event_url" type="text" class="txtinp"></span>
				 </div>
				 <div class="row">
				 <span class="label2">Event Date:</span>
				 <span class="formw"><input name="event_date" id="event_date" type="text" class="txtinp"></span>
				 </div>
				 <div class="row">
				 <span class="label2">Start Time:</span>
				 <span class="formw"><input name="event_start_time" id="event_start_time" class="txtinp" value="8:00 pm"></span>
				 </div>
				 <div class="row">
				 <span class="label2">End Time:</span>
				 <span class="formw"><input name="event_stop_time" id="event_stop_time" class="txtinp" value="10:30 pm"></span>
				 </div>
				 <div class="row">
				 <span class="label2">Location:</span>
				 <span class="formw"><input name="event_location" id="event_location"class="txtinp" type="Text"></span>
				 </div>
				 <div class="row">
				 <span class="label2">Address:</span>
				 <span class="formw"><input id="event_address" name="event_address" class="txtinp" type="Text"></span>
				 </div>
				 <div class="row">
				 <span class="label2">City:</span>
				 <span class="formw"><input id="event_city" name="event_city" class="txtinp" type="Text"></span>
				 </div>
				 <div class="row">
				 <span class="label2">State:</span>
				 <span class="formw"><input id="event_state" name="event_state" class="txtinp" type="Text"></span>
				 </div>
				 <div class="row">
				 <span class="label2">Zip:</span>
				 <span class="formw"><input id="event_zip" name="event_zip" class="txtinp" type="Text"></span>
				 </div>
				 <div class="row">
				 <span class="label2">Square Dance Program:</span>
				 <span class="formw">
					<input type="checkbox" value="ms" id="event_sd_program_ms" name="event_sd_program[]">Mainstream&nbsp;
					<input type="checkbox" value="plus" id="event_sd_program_plus" name="event_sd_program[]">Plus&nbsp;
					<input type="checkbox" value="a1" id="event_sd_program_a1" name="event_sd_program[]">Advanced 1&nbsp;
					<input type="checkbox" value="a2" id="event_sd_program_a2" name="event_sd_program[]">Advanced 2&nbsp;
					<input type="checkbox" value="c1" id="event_sd_program_c1" name="event_sd_program[]">C1
				 </span>
				 </div>
				 <div class="row">
				 <span class="label2">Round Dance Program:</span>
				 <span class="formw">
					<input type="checkbox" value="I" id="event_rd_program_I" name="event_rd_program[]">Phase I&nbsp;
					<input type="checkbox" value="II" id="event_rd_program_II" name="event_rd_program[]">Phase II&nbsp;
					<input type="checkbox" value="III" id="event_rd_program_III" name="event_rd_program[]">Phase III&nbsp;
					<input type="checkbox" value="IV" id="event_rd_program_IV" name="event_rd_program[]">Phase IV&nbsp;
					<input type="checkbox" value="V" id="event_rd_program_V" name="event_rd_program[]">Phase V&nbsp;
					<input type="checkbox" value="VI" id="event_rd_program_VI" name="event_rd_program[]">Phase VI
				 </span>
				 </div>
					 <div class="row">
						 <span class="label2">Caller(s):</span>
						 <span class="formw"><input id="event_caller" name="event_caller" class="txtinp" type=text></span>
					 </div>
					 <div class="row">
						 <span class="label2">Cuer(s):</span>
						 <span class="formw"><input id="event_cuer" name="event_cuer" class="txtinp" type=text></span>
					 </div>
					 <div class="row">
						 ...
						 <span class=thirda  style="width:20%;"><span class=boldcu>Name:</span><br>
							 <? 
							  for ($i=0;$i<3;$i++)
							 	echo '<input type=text  class="txtinp" name="contact_name[]" id="event_contact_name_' . $i . '">' . "\n";
							 ?>
						 </span>
						 <span class=thirda style="width:20%"><span class=boldcu>Email:</span><br>
							 <? for ($i=0;$i<3;$i++)
							 	echo '<input type=text  class="txtinp" name="contact_email[]" id="event_contact_email_' . $i . '">' . "\n";
							 ?>
						 </span>
						 <span class=thirda style="width:20%"><span class=boldcu>Phone:</span><br>
							 <? for ($i=0;$i<3;$i++)
							 	echo '<input type=text  class="txtinp" name="contact_phone[]" id="event_contact_phone_' . $i . '">' . "\n";
							 ?>
						 </span>
					 </div>
				 </form> 
